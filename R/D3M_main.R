...
#' @examples 
#' nrep <- 12
#' cases <- Map(rbeta,rep(50,nrep),rep(1,nrep),rep(5,nrep)); cases <- do.call("rbind",cases)
#' control <- Map(rbeta,rep(50,nrep),rep(1,nrep),rep(5,nrep)); control <- do.call("rbind",control)
#' d3m(cases,control,paranum = 101, q = 2, bsn = 5000,seed = 100)
#' 
#' @return  pval p-value.
